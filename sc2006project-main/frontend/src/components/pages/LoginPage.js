...
import { useUser } from '../../contexts/UserContext';
  ...
  function LoginPage() {
    ...
    const handleLogin = async (event) => {
      ...
      try {
       const response = await fetch(https://sc2006projectwebsitedeploy.onrender.com:4000/api/authentication/login', {
        method: 'POST',
        headers: {
      ...
      if(!response.ok) {
        ...
        const redirectRoute = json.userType === 'patron' ? '/home' : '/restProfile';
